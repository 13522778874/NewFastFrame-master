...
//                top = (getMeasuredHeight() - rightMenu.getMeasuredHeight()) / 2;
                CommonLogger.e("这里平衡" + "本地" + getMeasuredHeight() + "item" + rightMenu.getMeasuredHeight());
            }
